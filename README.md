...
- Building real-world projects that reflect production-level engineering  
- Strengthening system design and scalable architecture thinking  
- Creating AI-integrated applications with practical use cases  
- Improving performance, reliability, and maintainability of backend systems  

---

## Tech stack

Java • Spring Boot • React • JavaScript • PL/SQL • PostgreSQL • Oracle  
AWS • Azure • REST APIs • Docker • CI/CD • Kafka  

---

## What you’ll find on this GitHub

I’m actively building this GitHub to reflect how I actually work as an engineer:

- Clean, structured backend systems  
- Microservices-based architectures  
- Practical, real-world projects  
- Thoughtful README documentation and design decisions  

---

## Connect with me

- LinkedIn: https://www.linkedin.com/in/sai-kanderi-6588b72a0/  
